...
export const ChangeProfilePage = () => {
  return Handlebars.compile(tmpl)({
    ...
    LoginValue: ProfileValueInput({
      title: 'Логин', value: 'ivan', typeInput: 'text', keyInput: 'login',
    }),
    NameValue: ProfileValueInput({
      title: 'Имя', value: 'Иван', typeInput: 'text', keyInput: 'first_name',
    }),
    FamilyValue: ProfileValueInput({
      title: 'Фамилия', value: 'Иванов', typeInput: 'text', keyInput: 'second_name',
    }),
    NameChatValue: ProfileValueInput({
      title: 'Имя в чате', value: 'Иван', typeInput: 'text', keyInput: 'display_name',
    }),
