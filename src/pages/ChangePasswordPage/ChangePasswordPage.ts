...
export const ChangePasswordPage = () => {
    return Handlebars.compile(tmpl)({
        ...
        OldPasswordValue: ProfileValueInput({ title: "Старый пароль", value: "", typeInput: 'password', keyInput: 'login' }),
        NewPasswordValue: ProfileValueInput({ title: "Новый пароль", value: "", typeInput: 'password', keyInput: 'login' }),
